...
class AdminProductController extends AbstractController
{
     ...
     */
    public function new(Request $request, ProductRepository $productRepository, UploadService $uploadService): Response
    {
        $product = new Product();
     ...
     */
    public function edit(Request $request, Product $product, ProductRepository $productRepository, UploadService $uploadService): Response
    {
        $form = $this->createForm(ProductType::class, $product);
        $form->handleRequest($request);
